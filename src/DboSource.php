...
class DboSource extends DataSource
{
    ...
    public function __destruct()
    {
        if ($this->_methodCacheChange) {
            Cache::put('method_cache', static::$methodCache);
        }
        parent::__destruct();
    }

    /**
     * Generate an alter syntax from Schema::compare()
     *
    ...
    public function cacheMethod($method, $key, $value = null)
    {
        ...
        if ( ! $this->_methodCacheChange && empty(static::$methodCache)) {
            static::$methodCache = (array) Cache::get('method_cache');
        }
        if ($value === null) {
     ...
     * @param  Schema   $schema    An instance of a subclass of Schema
